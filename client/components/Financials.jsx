      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          ...
          >
            ...
            >
              <i>Company Financial Information</i>
            </div>
            <Grid container spacing={3}>
              {/* --------------------{Basic EPS Annual}-------------------- */}
              <Grid item xs={6}>
                <Paper
                  ...
                  style={{
                    background: 'rgba(20,29,38, 1)',
                    color: props.companyData.metric
                      ? props.companyData.metric['epsBasicExclExtraItemsAnnual']
                        ? props.companyData.metric[
                    ...
                    ? props.companyData.metric['grossMarginTTM']
                      ? props.companyData.metric['grossMarginTTM'] !== null
                        ? 'Gross Profit Margin (TTM): ' +
                          props.companyData.metric['grossMarginTTM'].toFixed(
                            2
                          ) +
                          '%'
                        : 'Gross Profit Margin (TTM)'
              ...
              <Grid item xs={4}>
                <Paper
                  ...
                  style={{
                    background: 'rgba(20,29,38, 1)',
                    color: props.companyData.metric
                      ? props.companyData.metric['freeCashFlowPerShareTTM']
                        ? props.companyData.metric['freeCashFlowPerShareTTM'] >
                          0
                          ? 'mediumseagreen'
                          : 'crimson'
                ...
                >
                  {props.companyData.metric
                    ? props.companyData.metric['quickRatioAnnual']
                      ? props.companyData.metric['quickRatioAnnual'] !== null
                        ? 'Annual Quick Ratio: ' +
                          props.companyData.metric['quickRatioAnnual'].toFixed(
                            2
                          ) +
                          '%'
                        : 'Annual Quick Ratio'
              ...
              <Grid item xs={4}>
                <Paper
                  ...
                  style={{
                    background: 'rgba(20,29,38, 1)',
                    color: props.companyData.metric
                      ? props.companyData.metric['roeTTM']
              ...
              <Grid item xs={4}>
                <Paper
                  ...
                  style={{
                    background: 'rgba(20,29,38, 1)',
                    color: props.companyData.metric
                      ? props.companyData.metric['roiTTM']
